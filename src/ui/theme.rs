...
impl Theme {
    ...
    pub const BG_HOVER: Color32 =
        Color32::from_rgb(30, 36, 46);

    pub const BG_ACTIVE: Color32 =
        Color32::from_rgb(36, 44, 58);
    ...
    pub const BUY_GREEN_BG: Color32 =
        Color32::from_rgb(22, 38, 30);

    pub const SELL_RED: Color32 =
        Color32::from_rgb(196, 94, 94);

    pub const SELL_RED_BG: Color32 =
        Color32::from_rgb(42, 24, 24);
